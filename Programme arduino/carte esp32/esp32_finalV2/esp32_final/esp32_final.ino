...
void writefirebase(const char* s){
  ...
  sscanf(s, "%3d,%3d,%3d,%3d,%3d,%3d,%3d", &a, &b, &c, &d, &e, &f, &g);
  Firebase.RTDB.setInt(&fbdo, "/Servomoteurs/Pince/Pince", a);
  Firebase.RTDB.setInt(&fbdo, "/Servomoteurs/Pince/Rotation", b);
  Firebase.RTDB.setInt(&fbdo, "/Servomoteurs/Pince/Inclinaison", c);
  Firebase.RTDB.setInt(&fbdo, "/Servomoteurs/Bras/Rotation", d);
  Firebase.RTDB.setInt(&fbdo, "/Servomoteurs/Bras/Tourne", e);
  Firebase.RTDB.setInt(&fbdo, "/Servomoteurs/Bras/Bras", f);
  Firebase.RTDB.setInt(&fbdo, "/Servomoteurs/Bras/AvantBras", g);
